...
Currently there are 22 tests. Some of them use pointers. Results of some of them are expected to be positive (undefined behavior found), some are expected to be negative. See details in the table:\\

\begin{centering}
\begin{tabular}{|l|l|l|}
\hline
                 & Positive & Negative \\\hline
With pointers    & 7        & 4        \\\hline
...
\textbf{Specificity}                   &  \textbf{67\%}   \\\hline
Fall-out                               &           33\%   \\\hline
...
The run took about 0.04 s on the testing machine (Intel Core i7 @ 2900 Mhz) on Example 2~\ref{example2} and is generally fast enough to be used as a part of compilation.
